                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                ...
                                echo "<td>"; ?> <a href="approve.php?id=<?php echo $row["id"]; ?>" style="color:#3399FF" >Approve</a> <?php echo "</td>";
                                echo "<td>"; ?> <a href="reject.php?id=<?php echo $row["id"]; ?>" style="color:red">Reject</a> <?php echo "</td>";
                                echo "</tr>";
                                }
                                echo "</table>";
                                ?>
