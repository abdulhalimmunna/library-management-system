                ...
                <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                    <div class="menu_section">
                        ...
                        <ul class="nav side-menu">
                            <li><a href="my_issued_books.php"><i class="fa fa-home"></i> My Issued Books <span class=""></span></a>

                            </li>
                            <li><a href="search_books.php"><i class="fa fa-edit"></i> Search Books <span class=""></span></a>

                            </li>
                            <li><a href="message_from_librarian.php"><i class="fa fa-envelope-o"></i> Librarain Messages <span
                                    class=""></span></a>
